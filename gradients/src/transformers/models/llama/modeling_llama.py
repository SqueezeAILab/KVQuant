...
class LlamaAttention(nn.Module):
    ...
    def __init__(self, config: LlamaConfig, layer_idx: Optional[int] = None):
        ...
        self.k_proj = LinearAct(self.hidden_size, self.num_key_value_heads * self.head_dim, bias=False)
        self.v_proj = LinearAct(self.hidden_size, self.num_key_value_heads * self.head_dim, bias=False)
